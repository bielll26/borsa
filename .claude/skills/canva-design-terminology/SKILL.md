...
> **QUICK REFERENCE**
> This is a READ-ONLY reference skill. It provides design knowledge but does NOT run scripts.
> No API calls needed. Just use the information below to answer design questions.
...
- Actually editing designs → Use editing skills
- API operations → Use other skills
- Generating content → Use `canva-content-generator`
...
- Dark gray on light gray: 4.5:1+ ✓

Poor contrast examples:
- Light gray on white: 2:1 ✗
- Yellow on white: 1.5:1 ✗
```
